...
import { View, Text, ScrollView, RefreshControl, StyleSheet, Image, TouchableOpacity, SafeAreaView, FlatList } from 'react-native';
...
export default function ExploreScreen() {
  ...
  const [filters, setFilters] = useState({
    ...
    guests: parseInt(searchParams.guests as string || '1'),
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme === 'dark' ? '#03120c' : '#fafafa' }]}>
      <FlatList
        data={[
          ...
          { type: 'listings', key: 'listings' },
          { type: 'cta', key: 'cta', show: !isAuthenticated },
        ]}
        renderItem={({ item }) => {
          if (item.type === 'search') {
            return (
        ...
        ListEmptyComponent={<View style={styles.bottomSpacer} />}
